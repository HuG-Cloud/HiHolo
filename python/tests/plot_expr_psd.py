...
datasets = [
    # PASNet 的 Probe
    {"file": "../recons_expr/obj_AP.h5", "label": "AP", "color": "#000000", "ls": "-", "lw": 2.0, "zorder": 1, "alpha": 0.9},
    {"file": "../recons_expr/obj_APWP.h5", "label": "APWP", "color": "tab:blue", "ls": "-", "lw": 2.0, "zorder": 2, "alpha": 0.8}, # 使用柔和的蓝色
    {"file": "../recons_expr/obj_pure.h5", "label": "PASNet", "color": "#e63946", "ls": "-", "lw": 2.5, "zorder": 3, "alpha": 1.0} # PASNet 线宽加粗
]
...
# 调整边距并保存
plt.tight_layout()
plt.savefig('psd_obj_plot.png', dpi=300)
print("Plot saved to psd_obj_plot.png")
plt.show()
