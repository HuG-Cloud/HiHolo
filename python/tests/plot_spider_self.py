...
datasets = [
    {"file": "../recons_spider_self/obj_physen.h5", "label": "PhysenNet", "color": "tab:blue", "ls": "-", "lw": 2.0, "zorder": 1, "alpha": 0.8},
    {"file": "../recons_spider_self/obj_cvnn.h5", "label": "CVNN", "color": "tab:orange", "ls": "-", "lw": 2.0, "zorder": 2, "alpha": 0.8},
    {"file": "../recons_spider_self/obj_self.h5", "label": "SelfPhish", "color": "tab:green", "ls": "-", "lw": 2.0, "zorder": 3, "alpha": 0.8},
    # PNet 是重点展示的方法，使用醒目的红色，线宽加粗，zorder 提高以显示在上方
    {"file": "../recons_spider_self/obj_pasnet.h5", "label": "PASNet", "color": "#e63946", "ls": "-", "lw": 2.0, "zorder": 4, "alpha": 1.0},
]
