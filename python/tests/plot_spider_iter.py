...
datasets = [
    {"file": "../recons_spider_iter/obj_AP.h5", "label": "AP", "color": "#0033cc", "ls": "-", "lw": 2.0, "zorder": 1, "alpha": 0.8},
    {"file": "../recons_spider_iter/obj_RAAR.h5", "label": "RAAR", "color": "tab:orange", "ls": "-", "lw": 2.0, "zorder": 2, "alpha": 0.8},
    {"file": "../recons_spider_iter/obj_HIO.h5", "label": "HIO", "color": "tab:green", "ls": "-", "lw": 2.0, "zorder": 3, "alpha": 0.8},
    # PNet 是重点展示的方法，使用醒目的红色，线宽加粗，zorder 提高以显示在上方
    {"file": "../recons_spider_iter/obj_APWP.h5", "label": "APWP", "color": "#e63946", "ls": "-", "lw": 2.5, "zorder": 4, "alpha": 1.0},
]
